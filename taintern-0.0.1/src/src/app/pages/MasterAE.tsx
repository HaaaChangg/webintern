  ...
  const columns = useMemo(() => {
    return currentData.headers
      ...
      .map(header => {
        ...
        const isAmount = h.includes('TOTAL') || h.includes('CHARGE') || h.includes('PAYMENT') || h.includes('AE') || h.includes('LỆCH') || h.includes('TIỀN');
        const isDate = h === 'FROM' || h === 'TO' || h.includes('DATE') || h.includes('NGÀY');
