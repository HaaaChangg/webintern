...
export function DashboardCharts() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10 min-h-[400px]">
      {/* Bar Chart: Top Centers by Payroll */}
      <div className="bg-white/65 backdrop-blur-2xl p-8 rounded-[2.5rem] border-2 border-slate-900/10 shadow-hard-sm relative overflow-hidden group min-h-[400px] flex flex-col">
